...
2. **Write** it to `output/permissions.json`.
...
If `src.permissions_builder` is unavailable, fall back to the `xlsx` skill,
preserving the same four sheets, columns, colours, and RTL.
